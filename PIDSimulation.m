...
% Last Modified by GUIDE v2.5 01-Aug-2017 13:13:31
...
% --- Executes on button press in pidTuneButton.
function pidTuneButton_Callback(hObject, eventdata, handles)
pidTuner

% hObject    handle to pidTuneButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in sysIDButton.
function sysIDButton_Callback(hObject, eventdata, handles)
systemIdentification
% hObject    handle to sysIDButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
