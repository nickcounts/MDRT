% Counts, 10-04-13 - Spaceport Support Services
...
% Launch the mini-GUI to read parameters from the Excel configuration
% spreadsheet
graph = getPlotParameters();

% Load the project configuration (paths to data, plots and raw data)
config = getConfig;

% TODO: Make this thing look in the right places automatically - sheesh
load('./ORB-2/data/timeline.mat');
