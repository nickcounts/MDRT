...
% -------------------------------------------------------------------------
    ...
    b_wide  = 137;
    b_tall  = 21;
    tags    = {'dataArchive';'importDataPath';'outputPath';'workingPath';'graphConfig';'saveConfig'};
...
% -------------------------------------------------------------------------
    ...
    hs.button_import =     uicontrol(hs.fig,...
            'String',       'Import Data Path',...
            'Callback',     @pushButtonCallback,...
            'Tag',          tags{2},...
            'ToolTipString','Set Data Archive Path',...
    ...
    hs.button_graphConfig = uicontrol(hs.fig,...
            ...
            'Position',      [b_x_loc, b_y_loc(5), b_wide, b_tall]);
...
% -------------------------------------------------------------------------
	...
	hs.edit_importDataPath = uicontrol(hs.fig,...
            'Style',        'edit',...
            'String',       '',...
            'HorizontalAlignment' , 'left',...
    ...
    hs.edit_graphConfigPath =   uicontrol(hs.fig,...
            ...
            'String',       '',...
            'HorizontalAlignment' , 'left',...
            'Position',     [eb_x_loc, eb_y_loc(5), eb_width, eb_height],...
            'tag',          'graphConfigPath');
...
% -------------------------------------------------------------------------
    ...
    function populateEditBoxContents()
        ...
        hs.edit_importAreaPath.String   = config.importDataPath;
